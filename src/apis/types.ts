...
export interface ParameterGroupingListItem {
    id: number;
    name: string;
...
export interface ParameterGroupingListResponse {
    data: ParameterGroupingListItem[];
    page: number;
    per_page: number;
    total: number;
}

export interface ParameterGroupingDetail {
    id: number;
    loan_type_name: string;
    name: string;
    type_of_group: ParameterGroupType | string;
    group_scoring_weight: number;
    scoring_rule_json: Record<string, unknown>[];
    children_parameter_groupings: ParameterGroupingDetail[];
    created_at: string;
    updated_at: string;
}

export interface ParameterGroupingCreatePayload {
    name: string;
...
export interface ParameterGroupingUpdatePayload {
    name?: string;
    type_of_group?: ParameterGroupType;
    group_scoring_weight?: number;
    scoring_rule_json?: Record<string, unknown>[];
...
export interface ParameterGroupingLinkParentPayload {
    parent_parameter_group_id: number;
    group_scoring_weight: number;
}
